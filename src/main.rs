...
fn main() {
    ...
    graphic.draw_and_save((640, 480), w!("typography.png"), |ctx| unsafe {
        ...
        let typography = write_factory.CreateTypography().unwrap();
        ...
        text_layout.SetTypography(&typography, DWRITE_TEXT_RANGE { startPosition: 0, length: text_length }).unwrap();
        let origin = D2D_POINT_2F {
            x: 0.0,
            y: 100.0,
        };
